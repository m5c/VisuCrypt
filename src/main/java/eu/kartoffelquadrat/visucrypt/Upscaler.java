...
/**
 * Utility class. Offers method that transforms a bool[][] and transforms it into a booger bool[][]
 * with quadrupled dimensions. Uses deisgnated patterns to extend false and true. It can be seen as
 * the transformation from a compact share (not usable for visual cryptography) to a visual share
 * (usable for visual cryptography)
 * <p>
 * False becomes: FT TF
 * <p>
 * True becomes TF FT
